            ...
            <DialogContent className="sm:max-w-[500px] border-none shadow-2xl">
                ...
                <div className="space-y-6 py-4">
                    ...
                    <div className={`p-6 rounded-2xl flex flex-col items-center justify-center ${isIncome ? 'bg-emerald-500/10' : 'bg-rose-500/10'}`}>
                        ...
                        <span className="text-sm font-medium mt-1 text-muted-foreground capitalize">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="p-3 bg-muted/30 rounded-xl flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                                <span className="text-[10px] uppercase font-bold text-muted-foreground">Recurrence</span>
                                <span className="text-sm font-medium capitalize">{transaction.isRecurring ? transaction.recurringInterval : 'One-time'}</span>
                            </div>
                        </div>
                    </div>
